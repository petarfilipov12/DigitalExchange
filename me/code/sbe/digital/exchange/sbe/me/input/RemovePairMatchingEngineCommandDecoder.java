...
public final class RemovePairMatchingEngineCommandDecoder
{
    ...
    private final RemovePairMatchingEngineCommandDecoder parentMessage = this;
    ...
    public RemovePairMatchingEngineCommandDecoder wrap(
    ...
    public RemovePairMatchingEngineCommandDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public RemovePairMatchingEngineCommandDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[RemovePairMatchingEngineCommand](sbeTemplateId=");
    ...
    public RemovePairMatchingEngineCommandDecoder sbeSkip()
    {
        sbeRewind();
