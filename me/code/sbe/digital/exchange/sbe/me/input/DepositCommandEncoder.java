...
public final class DepositCommandEncoder
{
    ...
    private final DepositCommandEncoder parentMessage = this;
    ...
    public DepositCommandEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public DepositCommandEncoder wrapAndApplyHeader(
    ...
    public DepositCommandEncoder seqNum(final long value)
    {
    ...
    public DepositCommandEncoder accountId(final long value)
    {
    ...
    public DepositCommandEncoder symbol(final int index, final byte value)
    {
        if (index < 0 || index >= 4)
        {
    ...
    public DepositCommandEncoder putSymbol(final byte value0, final byte value1, final byte value2, final byte value3)
    {
    ...
    public DepositCommandEncoder putSymbol(final byte[] src, final int srcOffset)
    {
        final int length = 4;
    ...
    public DepositCommandEncoder symbol(final String src)
    {
        final int length = 4;
    ...
    public DepositCommandEncoder symbol(final CharSequence src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public DepositCommandEncoder qty(final long value)
    {
