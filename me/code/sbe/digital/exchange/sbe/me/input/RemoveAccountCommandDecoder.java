...
public final class RemoveAccountCommandDecoder
{
    ...
    private final RemoveAccountCommandDecoder parentMessage = this;
    ...
    public RemoveAccountCommandDecoder wrap(
    ...
    public RemoveAccountCommandDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public RemoveAccountCommandDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[RemoveAccountCommand](sbeTemplateId=");
    ...
    public RemoveAccountCommandDecoder sbeSkip()
    {
        sbeRewind();
