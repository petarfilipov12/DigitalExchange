...
public final class WithdrawCommandDecoder
{
    ...
    private final WithdrawCommandDecoder parentMessage = this;
    ...
    public WithdrawCommandDecoder wrap(
    ...
    public WithdrawCommandDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public WithdrawCommandDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[WithdrawCommand](sbeTemplateId=");
    ...
    public WithdrawCommandDecoder sbeSkip()
    {
        sbeRewind();
