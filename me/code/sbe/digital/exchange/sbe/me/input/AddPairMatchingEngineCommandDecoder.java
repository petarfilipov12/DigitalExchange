...
public final class AddPairMatchingEngineCommandDecoder
{
    ...
    private final AddPairMatchingEngineCommandDecoder parentMessage = this;
    ...
    public AddPairMatchingEngineCommandDecoder wrap(
    ...
    public AddPairMatchingEngineCommandDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public AddPairMatchingEngineCommandDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[AddPairMatchingEngineCommand](sbeTemplateId=");
    ...
    public AddPairMatchingEngineCommandDecoder sbeSkip()
    {
        sbeRewind();
