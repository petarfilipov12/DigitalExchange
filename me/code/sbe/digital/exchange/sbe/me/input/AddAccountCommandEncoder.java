...
public final class AddAccountCommandEncoder
{
    ...
    private final AddAccountCommandEncoder parentMessage = this;
    ...
    public AddAccountCommandEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public AddAccountCommandEncoder wrapAndApplyHeader(
    ...
    public AddAccountCommandEncoder seqNum(final long value)
    {
    ...
    public AddAccountCommandEncoder accountId(final long value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final AddAccountCommandDecoder decoder = new AddAccountCommandDecoder();
