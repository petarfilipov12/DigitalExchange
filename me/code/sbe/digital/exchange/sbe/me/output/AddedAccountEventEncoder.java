...
public final class AddedAccountEventEncoder
{
    ...
    private final AddedAccountEventEncoder parentMessage = this;
    ...
    public AddedAccountEventEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public AddedAccountEventEncoder wrapAndApplyHeader(
    ...
    public AddedAccountEventEncoder seqNum(final long value)
    {
    ...
    public AddedAccountEventEncoder timestamp(final long value)
    {
    ...
    public AddedAccountEventEncoder accountId(final long value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final AddedAccountEventDecoder decoder = new AddedAccountEventDecoder();
