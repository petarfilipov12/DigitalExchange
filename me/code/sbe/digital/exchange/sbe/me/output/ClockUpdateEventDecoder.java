...
public final class ClockUpdateEventDecoder
{
    ...
    private final ClockUpdateEventDecoder parentMessage = this;
    ...
    public ClockUpdateEventDecoder wrap(
    ...
    public ClockUpdateEventDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ClockUpdateEventDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[ClockUpdateEvent](sbeTemplateId=");
    ...
    public ClockUpdateEventDecoder sbeSkip()
    {
        sbeRewind();
