...
public final class AddedAccountEventDecoder
{
    ...
    private final AddedAccountEventDecoder parentMessage = this;
    ...
    public AddedAccountEventDecoder wrap(
    ...
    public AddedAccountEventDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public AddedAccountEventDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[AddedAccountEvent](sbeTemplateId=");
    ...
    public AddedAccountEventDecoder sbeSkip()
    {
        sbeRewind();
