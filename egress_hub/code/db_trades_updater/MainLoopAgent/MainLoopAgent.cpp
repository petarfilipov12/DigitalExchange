...
bool MainLoopAgent::readMessageAndPushToDb()
{
    ...
    sbeUtilsHubInner.PrintMsg(mappedBuffer_ptr->getMappedBuffer(), MessageMappedBuffer::bufferLength);

    return tradesDispatcher.dispatch(
