...
public final class PositionUpdateEncoder
{
    ...
    private final PositionUpdateEncoder parentMessage = this;
    ...
    public PositionUpdateEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public PositionUpdateEncoder wrapAndApplyHeader(
    ...
    public PositionUpdateEncoder hubServiceId(final int value)
    {
    ...
    public PositionUpdateEncoder position(final long value)
    {
