...
#ifndef _DIGITAL_EXCHANGE_SBE_ME_OUTPUT_ADDEDACCOUNTEVENT_CXX_H_
#define _DIGITAL_EXCHANGE_SBE_ME_OUTPUT_ADDEDACCOUNTEVENT_CXX_H_
...
public:
    ...
    AddedAccountEvent(char *buffer, const std::uint64_t bufferLength) :
        AddedAccountEvent(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    AddedAccountEvent(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        AddedAccountEvent(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    AddedAccountEvent &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    AddedAccountEvent &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    AddedAccountEvent &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    {
        AddedAccountEvent skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    AddedAccountEvent &seqNum(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    AddedAccountEvent &timestamp(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    AddedAccountEvent &accountId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const AddedAccountEvent &_writer)
{
    AddedAccountEvent writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "AddedAccountEvent", )";
