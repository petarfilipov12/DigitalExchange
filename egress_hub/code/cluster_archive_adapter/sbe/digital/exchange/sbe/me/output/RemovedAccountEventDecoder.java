...
public final class RemovedAccountEventDecoder
{
    ...
    private final RemovedAccountEventDecoder parentMessage = this;
    ...
    public RemovedAccountEventDecoder wrap(
    ...
    public RemovedAccountEventDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public RemovedAccountEventDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[RemovedAccountEvent](sbeTemplateId=");
    ...
    public RemovedAccountEventDecoder sbeSkip()
    {
        sbeRewind();
