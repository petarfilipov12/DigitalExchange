...
public final class WithdrawEventEncoder
{
    ...
    private final WithdrawEventEncoder parentMessage = this;
    ...
    public WithdrawEventEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public WithdrawEventEncoder wrapAndApplyHeader(
    ...
    public WithdrawEventEncoder seqNum(final long value)
    {
    ...
    public WithdrawEventEncoder timestamp(final long value)
    {
    ...
    public WithdrawEventEncoder accountId(final long value)
    {
    ...
    public WithdrawEventEncoder symbol(final int index, final byte value)
    {
        if (index < 0 || index >= 4)
        {
    ...
    public WithdrawEventEncoder putSymbol(final byte value0, final byte value1, final byte value2, final byte value3)
    {
    ...
    public WithdrawEventEncoder putSymbol(final byte[] src, final int srcOffset)
    {
        final int length = 4;
    ...
    public WithdrawEventEncoder symbol(final String src)
    {
        final int length = 4;
    ...
    public WithdrawEventEncoder symbol(final CharSequence src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public WithdrawEventEncoder qty(final long value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final WithdrawEventDecoder decoder = new WithdrawEventDecoder();
