...
public final class MeMessageDecoder
{
    ...
    private final MeMessageDecoder parentMessage = this;
    ...
    public MeMessageDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public MeMessageDecoder sbeRewind()
    {
    ...
    public static int messageBytesSinceVersion()
    {
        return 0;
    }
    ...
    public int getMessageBytes(final MutableDirectBuffer dst, final int dstOffset, final int length)
    {
        final int headerLength = 4;
        final int limit = parentMessage.limit();
        final int dataLength = (int)(buffer.getInt(limit, BYTE_ORDER) & 0xFFFF_FFFFL);
    ...
    public int getMessageBytes(final byte[] dst, final int dstOffset, final int length)
    {
        final int headerLength = 4;
        final int limit = parentMessage.limit();
        final int dataLength = (int)(buffer.getInt(limit, BYTE_ORDER) & 0xFFFF_FFFFL);
    ...
    public void wrapMessageBytes(final DirectBuffer wrapBuffer)
    {
        final int headerLength = 4;
        final int limit = parentMessage.limit();
        final int dataLength = (int)(buffer.getInt(limit, BYTE_ORDER) & 0xFFFF_FFFFL);
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[MeMessage](sbeTemplateId=");
        ...
        builder.append('|');
        builder.append("messageBytes=");
        builder.append(skipMessageBytes()).append(" bytes of raw data");
    ...
    public MeMessageDecoder sbeSkip()
    {
        sbeRewind();
        skipMessageBytes();
