...
#ifndef _DIGITAL_EXCHANGE_SBE_ME_OUTPUT_REMOVEDACCOUNTEVENT_CXX_H_
#define _DIGITAL_EXCHANGE_SBE_ME_OUTPUT_REMOVEDACCOUNTEVENT_CXX_H_
...
public:
    ...
    RemovedAccountEvent(char *buffer, const std::uint64_t bufferLength) :
        RemovedAccountEvent(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    RemovedAccountEvent(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        RemovedAccountEvent(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    RemovedAccountEvent &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    RemovedAccountEvent &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    RemovedAccountEvent &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    {
        RemovedAccountEvent skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    RemovedAccountEvent &seqNum(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    RemovedAccountEvent &timestamp(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    RemovedAccountEvent &accountId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const RemovedAccountEvent &_writer)
{
    RemovedAccountEvent writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "RemovedAccountEvent", )";
