...
/**
 * Maker Order Added Event
 */
@SuppressWarnings("all")
public final class MakerOrderAddedEventDecoder
{
    ...
    private final MakerOrderAddedEventDecoder parentMessage = this;
    ...
    public MakerOrderAddedEventDecoder wrap(
    ...
    public MakerOrderAddedEventDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public MakerOrderAddedEventDecoder sbeRewind()
    {
    ...
    public String toString()
    {
        ...
        final MakerOrderAddedEventDecoder decoder = new MakerOrderAddedEventDecoder();
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[MakerOrderAddedEvent](sbeTemplateId=");
    ...
    public MakerOrderAddedEventDecoder sbeSkip()
    {
        sbeRewind();
