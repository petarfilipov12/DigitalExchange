...
public final class DepositEventDecoder
{
    ...
    private final DepositEventDecoder parentMessage = this;
    ...
    public DepositEventDecoder wrap(
    ...
    public DepositEventDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public DepositEventDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[DepositEvent](sbeTemplateId=");
    ...
    public DepositEventDecoder sbeSkip()
    {
        sbeRewind();
