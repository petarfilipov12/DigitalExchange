...
public final class RemovedPairMatchingEngineEventDecoder
{
    ...
    private final RemovedPairMatchingEngineEventDecoder parentMessage = this;
    ...
    public RemovedPairMatchingEngineEventDecoder wrap(
    ...
    public RemovedPairMatchingEngineEventDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public RemovedPairMatchingEngineEventDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[RemovedPairMatchingEngineEvent](sbeTemplateId=");
    ...
    public RemovedPairMatchingEngineEventDecoder sbeSkip()
    {
        sbeRewind();
