...
public final class WithdrawCommandEncoder
{
    ...
    private final WithdrawCommandEncoder parentMessage = this;
    ...
    public WithdrawCommandEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public WithdrawCommandEncoder wrapAndApplyHeader(
    ...
    public WithdrawCommandEncoder seqNum(final long value)
    {
    ...
    public WithdrawCommandEncoder accountId(final long value)
    {
    ...
    public WithdrawCommandEncoder symbol(final int index, final byte value)
    {
        if (index < 0 || index >= 4)
        {
    ...
    public WithdrawCommandEncoder putSymbol(final byte value0, final byte value1, final byte value2, final byte value3)
    {
    ...
    public WithdrawCommandEncoder putSymbol(final byte[] src, final int srcOffset)
    {
        final int length = 4;
    ...
    public WithdrawCommandEncoder symbol(final String src)
    {
        final int length = 4;
    ...
    public WithdrawCommandEncoder symbol(final CharSequence src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public WithdrawCommandEncoder qty(final long value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final WithdrawCommandDecoder decoder = new WithdrawCommandDecoder();
