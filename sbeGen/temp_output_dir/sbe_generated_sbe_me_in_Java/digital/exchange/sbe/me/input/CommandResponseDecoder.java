...
public final class CommandResponseDecoder
{
    ...
    private final CommandResponseDecoder parentMessage = this;
    ...
    public CommandResponseDecoder wrap(
    ...
    public CommandResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public CommandResponseDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[CommandResponse](sbeTemplateId=");
    ...
    public CommandResponseDecoder sbeSkip()
    {
        sbeRewind();
