package digital.exchange.ingress.rest.server.app.resources.mepair.add;
...
@Path("/add_pair")
@ApplicationScoped
public class AddPairResource
{

    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Uni<Response> addPair(AddPairRequest addPairRequest)
    {
        ...
        Runnable runnable = () ->
        {
            boolean res = MeClusterSender.sendAddPairMatchingEngine(addPairRequest.base(), addPairRequest.quote(), seqNum);
