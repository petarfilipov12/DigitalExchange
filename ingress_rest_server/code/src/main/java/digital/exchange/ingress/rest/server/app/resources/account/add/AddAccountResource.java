package digital.exchange.ingress.rest.server.app.resources.account.add;
...
public class AddAccountResource
{
    ...
    public Uni<Response> createAccount(AddAccountRequest addAccountRequest)
    {
        ...
        Runnable runnable = () ->
        {
            boolean res = MeClusterSender.sendAddAccount(addAccountRequest.accountId(), seqNum);
