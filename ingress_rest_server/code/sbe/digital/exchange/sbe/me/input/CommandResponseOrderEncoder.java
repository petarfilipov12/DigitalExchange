...
public final class CommandResponseOrderEncoder
{
    ...
    private final CommandResponseOrderEncoder parentMessage = this;
    ...
    public CommandResponseOrderEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public CommandResponseOrderEncoder wrapAndApplyHeader(
    ...
    public CommandResponseOrderEncoder seqNum(final long value)
    {
    ...
    public CommandResponseOrderEncoder response(final ResponseEnum value)
    {
    ...
    private final OrderEncoder order = new OrderEncoder();

    public OrderEncoder order()
    {
