...
public final class AddOrderCommandEncoder
{
    ...
    private final AddOrderCommandEncoder parentMessage = this;
    ...
    public AddOrderCommandEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public AddOrderCommandEncoder wrapAndApplyHeader(
    ...
    public AddOrderCommandEncoder seqNum(final long value)
    {
    ...
    public AddOrderCommandEncoder base(final int index, final byte value)
    {
        if (index < 0 || index >= 4)
        {
    ...
    public AddOrderCommandEncoder putBase(final byte value0, final byte value1, final byte value2, final byte value3)
    {
    ...
    public AddOrderCommandEncoder putBase(final byte[] src, final int srcOffset)
    {
        final int length = 4;
    ...
    public AddOrderCommandEncoder base(final String src)
    {
        final int length = 4;
    ...
    public AddOrderCommandEncoder base(final CharSequence src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public AddOrderCommandEncoder quote(final int index, final byte value)
    {
        if (index < 0 || index >= 4)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public AddOrderCommandEncoder putQuote(final byte value0, final byte value1, final byte value2, final byte value3)
    {
    ...
    public AddOrderCommandEncoder putQuote(final byte[] src, final int srcOffset)
    {
        final int length = 4;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public AddOrderCommandEncoder quote(final String src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public AddOrderCommandEncoder quote(final CharSequence src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public AddOrderCommandEncoder accountId(final long value)
    {
    ...
    public AddOrderCommandEncoder price(final long value)
    {
    ...
    public AddOrderCommandEncoder qty(final long value)
    {
    ...
    public AddOrderCommandEncoder orderSide(final SbeOrderSide value)
    {
    ...
    public AddOrderCommandEncoder orderType(final SbeOrderType value)
    {
        buffer.putInt(offset + 44, value.value(), BYTE_ORDER);
        return this;
    }
