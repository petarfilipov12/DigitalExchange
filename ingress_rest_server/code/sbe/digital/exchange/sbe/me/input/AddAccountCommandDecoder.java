...
public final class AddAccountCommandDecoder
{
    ...
    private final AddAccountCommandDecoder parentMessage = this;
    ...
    public AddAccountCommandDecoder wrap(
    ...
    public AddAccountCommandDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public AddAccountCommandDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[AddAccountCommand](sbeTemplateId=");
    ...
    public AddAccountCommandDecoder sbeSkip()
    {
        sbeRewind();
