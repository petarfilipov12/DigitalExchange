...
import static digital.exchange.ws.server.cluster.client.fsm.ClusterClientFsmAgent.ClusterClientState.*;

public class ClusterClientFsmAgent implements Agent
{
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ClusterClientFsmAgent.class);
    ...
    private final ClusterClientFsmStateChangeListener stateChangeListener;
    ...
    public ClusterClientFsmAgent(
            ...
            final ClusterClientFsmStateChangeListener stateChangeListener
    )
    {
    ...
    private int connect()
    {
        ...
        if(state.compareAndSet(CONNECT, CONNECTED))
        {
            ...
            stateChangeListener.onConnected(this);
        }
    ...
    private int disconnect()
    {
        ...
        if(state.compareAndSet(DISCONNECT, DISCONNECTED))
        {
            ...
            stateChangeListener.onDisconnected(this);
        }
    ...
    private int idleConnected()
    {
        ...
        if(nanoClock.nanoTime() >= keepAliveDeadline)
        {
