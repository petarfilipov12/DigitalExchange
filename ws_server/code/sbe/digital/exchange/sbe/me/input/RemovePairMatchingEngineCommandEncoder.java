...
/**
 * Remove Pair from matching engine
 */
@SuppressWarnings("all")
public final class RemovePairMatchingEngineCommandEncoder
{
    ...
    private final RemovePairMatchingEngineCommandEncoder parentMessage = this;
    ...
    public RemovePairMatchingEngineCommandEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public RemovePairMatchingEngineCommandEncoder wrapAndApplyHeader(
    ...
    public RemovePairMatchingEngineCommandEncoder seqNum(final long value)
    {
    ...
    public RemovePairMatchingEngineCommandEncoder base(final int index, final byte value)
    {
        if (index < 0 || index >= 4)
        {
    ...
    public RemovePairMatchingEngineCommandEncoder putBase(final byte value0, final byte value1, final byte value2, final byte value3)
    {
    ...
    public RemovePairMatchingEngineCommandEncoder putBase(final byte[] src, final int srcOffset)
    {
        final int length = 4;
    ...
    public RemovePairMatchingEngineCommandEncoder base(final String src)
    {
        final int length = 4;
    ...
    public RemovePairMatchingEngineCommandEncoder base(final CharSequence src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public RemovePairMatchingEngineCommandEncoder quote(final int index, final byte value)
    {
        if (index < 0 || index >= 4)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public RemovePairMatchingEngineCommandEncoder putQuote(final byte value0, final byte value1, final byte value2, final byte value3)
    {
    ...
    public RemovePairMatchingEngineCommandEncoder putQuote(final byte[] src, final int srcOffset)
    {
        final int length = 4;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public RemovePairMatchingEngineCommandEncoder quote(final String src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public RemovePairMatchingEngineCommandEncoder quote(final CharSequence src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final RemovePairMatchingEngineCommandDecoder decoder = new RemovePairMatchingEngineCommandDecoder();
