...
/**
 * Add Pair to matching engine
 */
@SuppressWarnings("all")
public final class AddPairMatchingEngineCommandEncoder
{
    ...
    private final AddPairMatchingEngineCommandEncoder parentMessage = this;
    ...
    public AddPairMatchingEngineCommandEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public AddPairMatchingEngineCommandEncoder wrapAndApplyHeader(
    ...
    public AddPairMatchingEngineCommandEncoder seqNum(final long value)
    {
    ...
    public AddPairMatchingEngineCommandEncoder base(final int index, final byte value)
    {
        if (index < 0 || index >= 4)
        {
    ...
    public AddPairMatchingEngineCommandEncoder putBase(final byte value0, final byte value1, final byte value2, final byte value3)
    {
    ...
    public AddPairMatchingEngineCommandEncoder putBase(final byte[] src, final int srcOffset)
    {
        final int length = 4;
    ...
    public AddPairMatchingEngineCommandEncoder base(final String src)
    {
        final int length = 4;
    ...
    public AddPairMatchingEngineCommandEncoder base(final CharSequence src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public AddPairMatchingEngineCommandEncoder quote(final int index, final byte value)
    {
        if (index < 0 || index >= 4)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public AddPairMatchingEngineCommandEncoder putQuote(final byte value0, final byte value1, final byte value2, final byte value3)
    {
    ...
    public AddPairMatchingEngineCommandEncoder putQuote(final byte[] src, final int srcOffset)
    {
        final int length = 4;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public AddPairMatchingEngineCommandEncoder quote(final String src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public AddPairMatchingEngineCommandEncoder quote(final CharSequence src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final AddPairMatchingEngineCommandDecoder decoder = new AddPairMatchingEngineCommandDecoder();
