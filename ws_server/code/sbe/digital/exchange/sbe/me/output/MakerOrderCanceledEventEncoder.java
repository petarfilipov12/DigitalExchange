...
public final class MakerOrderCanceledEventEncoder
{
    ...
    private final MakerOrderCanceledEventEncoder parentMessage = this;
    ...
    public MakerOrderCanceledEventEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public MakerOrderCanceledEventEncoder wrapAndApplyHeader(
    ...
    public MakerOrderCanceledEventEncoder seqNum(final long value)
    {
    ...
    public MakerOrderCanceledEventEncoder timestamp(final long value)
    {
