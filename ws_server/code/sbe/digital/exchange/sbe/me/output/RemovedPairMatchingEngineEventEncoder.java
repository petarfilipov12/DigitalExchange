...
/**
 * Removed Pair Matching Engine Event
 */
@SuppressWarnings("all")
public final class RemovedPairMatchingEngineEventEncoder
{
    ...
    private final RemovedPairMatchingEngineEventEncoder parentMessage = this;
    ...
    public RemovedPairMatchingEngineEventEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public RemovedPairMatchingEngineEventEncoder wrapAndApplyHeader(
    ...
    public RemovedPairMatchingEngineEventEncoder seqNum(final long value)
    {
    ...
    public RemovedPairMatchingEngineEventEncoder timestamp(final long value)
    {
    ...
    public RemovedPairMatchingEngineEventEncoder base(final int index, final byte value)
    {
        if (index < 0 || index >= 4)
        {
    ...
    public RemovedPairMatchingEngineEventEncoder putBase(final byte value0, final byte value1, final byte value2, final byte value3)
    {
    ...
    public RemovedPairMatchingEngineEventEncoder putBase(final byte[] src, final int srcOffset)
    {
        final int length = 4;
    ...
    public RemovedPairMatchingEngineEventEncoder base(final String src)
    {
        final int length = 4;
    ...
    public RemovedPairMatchingEngineEventEncoder base(final CharSequence src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public RemovedPairMatchingEngineEventEncoder quote(final int index, final byte value)
    {
        if (index < 0 || index >= 4)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public RemovedPairMatchingEngineEventEncoder putQuote(final byte value0, final byte value1, final byte value2, final byte value3)
    {
    ...
    public RemovedPairMatchingEngineEventEncoder putQuote(final byte[] src, final int srcOffset)
    {
        final int length = 4;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public RemovedPairMatchingEngineEventEncoder quote(final String src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public RemovedPairMatchingEngineEventEncoder quote(final CharSequence src)
    {
        final int length = 4;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final RemovedPairMatchingEngineEventDecoder decoder = new RemovedPairMatchingEngineEventDecoder();
