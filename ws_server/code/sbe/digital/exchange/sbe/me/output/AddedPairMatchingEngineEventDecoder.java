...
public final class AddedPairMatchingEngineEventDecoder
{
    ...
    private final AddedPairMatchingEngineEventDecoder parentMessage = this;
    ...
    public AddedPairMatchingEngineEventDecoder wrap(
    ...
    public AddedPairMatchingEngineEventDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public AddedPairMatchingEngineEventDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[AddedPairMatchingEngineEvent](sbeTemplateId=");
    ...
    public AddedPairMatchingEngineEventDecoder sbeSkip()
    {
        sbeRewind();
