...
public final class WithdrawEventDecoder
{
    ...
    private final WithdrawEventDecoder parentMessage = this;
    ...
    public WithdrawEventDecoder wrap(
    ...
    public WithdrawEventDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public WithdrawEventDecoder sbeRewind()
    {
    ...
    public String symbol()
    {
        ...
        buffer.getBytes(offset + 24, dst, 0, 4);
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[WithdrawEvent](sbeTemplateId=");
    ...
    public WithdrawEventDecoder sbeSkip()
    {
        sbeRewind();
